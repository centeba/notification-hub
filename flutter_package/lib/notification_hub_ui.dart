...
///
/// The host application provides an authenticated API base URL / client and may
/// supply a translator via [MultiLangDelegate]; these screens share the host's
/// theme through [AppThemeColors].
...
// Core: API client, providers, theming, and the i18n shim (wire a translator)
